...
void DrawSprite(int winX ,int winY,void* pdds,int x, int y, int width , int height,int Bltflag=1); //컬러키는 현재 무조건 빼준다
...
extern int ReformItemRestaure(sITEMINFO* lpItemInfo);
