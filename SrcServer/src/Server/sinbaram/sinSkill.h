...
//ASSASSIN
#define SKILL_STINGGER  		(GROUP_ASSASSIN | CHANGE_JOB1 | SKILL_1)
#define SKILL_RUNNING_HIT       (GROUP_ASSASSIN | CHANGE_JOB1 | SKILL_2)
#define SKILL_DUALSWORDMASTERY  (GROUP_ASSASSIN | CHANGE_JOB1 | SKILL_3)
#define SKILL_WISP       		(GROUP_ASSASSIN | CHANGE_JOB1 | SKILL_4)

#define SKILL_VENOM_THRONE  	(GROUP_ASSASSIN | CHANGE_JOB2 | SKILL_1)
#define SKILL_ALAS      		(GROUP_ASSASSIN | CHANGE_JOB2 | SKILL_2)
#define SKILL_SOUL_SHOCK		(GROUP_ASSASSIN | CHANGE_JOB2 | SKILL_3)
#define SKILL_ATTACK_MASTERY    (GROUP_ASSASSIN | CHANGE_JOB2 | SKILL_4)

#define SKILL_SORE_SWORD       	(GROUP_ASSASSIN | CHANGE_JOB3 | SKILL_1)
#define SKILL_BEAT_UP       	(GROUP_ASSASSIN | CHANGE_JOB3 | SKILL_2)
#define SKILL_INPES     		(GROUP_ASSASSIN | CHANGE_JOB3 | SKILL_3)
#define SKILL_BLIND         	(GROUP_ASSASSIN | CHANGE_JOB3 | SKILL_4)

#define SKILL_FROST_WIND        (GROUP_ASSASSIN | CHANGE_JOB4 | SKILL_1)
#define SKILL_FATAL_MASTERY     (GROUP_ASSASSIN | CHANGE_JOB4 | SKILL_2)
#define SKILL_POLLUTED      	(GROUP_ASSASSIN | CHANGE_JOB4 | SKILL_3)
#define SKILL_PASTING_SHADOW    (GROUP_ASSASSIN | CHANGE_JOB4 | SKILL_4)
