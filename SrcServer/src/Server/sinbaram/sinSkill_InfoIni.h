...
#define smTRANSCODE_MECH_INFO 0x48500001
#define smTRANSCODE_FIGHTER_INFO 0x48500002
#define smTRANSCODE_PIKE_INFO 0x48500003
#define smTRANSCODE_ARCHER_INFO 0x48500004
#define smTRANSCODE_KINA_INFO 0x48500005
#define smTRANSCODE_ATA_INFO 0x48500006
#define smTRANSCODE_SACER_INFO 0x48500007
#define smTRANSCODE_MAGE_INFO 0x48500008
...
struct SACER_INFO {
	...
	int HolyBolt_Damage[10][2];

	int M_Spark_UseMana[10];
	int M_Spark_Damage[10][2];
	int M_Spark_Num[10];
	...
	int Divine_Lightning_Damage[10][2];
	...
	int Chain_Lightning_Damage[10][2];
...
struct MAGE_INFO {
	...
	int Flame_Wave_FireDamage[10][2];
...
struct ASSASSIN_INFO
{
	...
	int Polluted_Damage[10];
	int Polluted_Damage2[10][2];
	int Polluted_Area[10];
	int Polluted_Time[10];
	int Polluted_AttackNum[10];
	int Polluted_UseMana[10];
