...
char* szModel_AssassinFaceName[FACE_MODEL_MAX][HEAREPOTION_MAX] = {
	{
		"char\\tmABCD\\tfh-e01.inf" ,
		"char\\tmABCD\\tfh-e02.inf" ,
		"char\\tmABCD\\tfh-e03.inf" ,
		...
		"char\\tmABCD\\tfh-e12.inf" ,
		"char\\tmABCD\\tfh-e13.inf" ,
		"char\\tmABCD\\Tfh-E14t.inf",
		"char\\tmABCD\\Tfh-E15t.inf",
		"char\\tmABCD\\Tfh-E16t.inf",
		"char\\tmABCD\\Tfh-E17t.inf",
		"char\\tmABCD\\tfh-e19.inf" ,
		"char\\tmABCD\\tfh-e20.inf" ,
		"char\\tmABCD\\tfh-e21.inf" ,
		"char\\tmABCD\\tfh-e22.inf" ,
		"char\\tmABCD\\tfh-e23.inf" ,
		"char\\tmABCD\\Tfh-E24.inf",
		"char\\tmABCD\\Tfh-E25.inf",
		"char\\tmABCD\\Tfh-E26.inf"
	},
	{
		"char\\tmABCD\\tfh-e01a.inf",
		"char\\tmABCD\\tfh-e02a.inf",
...
char* szModel_AtalantaFaceName[FACE_MODEL_MAX][HEAREPOTION_MAX] = {
	{
		...
		"char\\tmABCD\\Mfh-B24.inf",//mascara
		"char\\tmABCD\\Mfh-B25.inf",//carneiro
		"char\\tmABCD\\Mfh-B26.inf", //desconhecido,
...
char* szModel_Magican[FACE_MODEL_MAX][HEAREPOTION_MAX] = {
	{
...
char* szArmorNumFile[10][ARMOR_FILE_MAX] = {
	{	//MECHANICIAN 
		...
		"A030.ini",  "A031.ini",  "A032.ini",
		// Trajes (Armaduras)
		"A001.ini",  "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini",
		"Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini",
		"Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini", "Ca001.ini",
		// Trajes (T)
		"Ca035.ini", "Ca004.ini", "Ca037.ini", "Ca029.ini", "Ca030.ini", "Ca031.ini", "Ca091.ini", "Ca038.ini", "Ca039.ini", "Ca012.ini",
	...
	{	//FIGHTER 
		...
		"B030.ini",  "B031.ini",  "B032.ini",
		// Trajes (Armaduras)
		"B001.ini",  "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini",
		"Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini",
		"Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini", "Cb001.ini",
		// Trajes (T)
		"Cb035.ini", "Cb004.ini", "Cb037.ini", "Cb029.ini", "Cb030.ini", "Cb031.ini", "Cb091.ini", "Cb038.ini", "Cb039.ini", "Cb012.ini",
	...
	{	//PIKEMAN 
		...
		"C030.ini",  "C031.ini",  "C032.ini",
		// Trajes (Armaduras)
		"C001.ini",  "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini",
		"Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini",
		"Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini", "Cc001.ini",
		// Trajes (T)
		"Cc035.ini", "Cc004.ini", "Cc037.ini", "Cc029.ini", "Cc030.ini", "Cc031.ini", "Cc091.ini", "Cc038.ini", "Cc039.ini", "Cc012.ini",
	...
	{	//ARCHER
		...
		"D030.ini",  "D031.ini",  "D032.ini",
		// Trajes (Armaduras)
		"D001.ini",  "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini",
		"Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini",
		"Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini", "Cd001.ini",
		// Trajes (T)
		"Cd035.ini", "Cd004.ini", "Cd037.ini", "Cd029.ini", "Cd030.ini", "Cd031.ini", "Cd091.ini", "Cd038.ini", "Cd039.ini", "Cd012.ini",
	...
	{	//KNIGHT 
		...
		"mA030.ini",  "mA031.ini",  "mA032.ini",
		// Trajes (Armaduras)
		"mA001.ini",  "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini",
		"Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini",
		"Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini", "Cma001.ini",
		// Trajes (T)
		"Cma035.ini", "Cma004.ini", "Cma037.ini", "Cma029.ini", "Cma030.ini", "Cma031.ini", "Cma091.ini", "Cma038.ini", "Cma039.ini", "Cma012.ini",
	...
	{	//ATALANTA 
		...
		"mB030.ini",  "mB031.ini",  "mB032.ini",
		// Trajes (Armaduras)
		"mB001.ini",  "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini",
		"Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini",
		"Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini", "Cmb001.ini",
		// Trajes (T)
		"Cmb035.ini", "Cmb004.ini", "Cmb037.ini", "Cmb029.ini", "Cmb030.ini", "Cmb031.ini", "Cmb091.ini", "Cmb038.ini", "Cmb039.ini", "Cmb012.ini",
	...
	{	//PRIESTESS
		...
		"mC030.ini",  "mC031.ini",  "mC032.ini",
		// Trajes (Armaduras)
		"mC001.ini",  "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini",
		"Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini",
		"Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini", "Cmc001.ini",
		// Trajes (T)
		"Cmc035.ini", "Cmc004.ini", "Cmc037.ini", "Cmc029.ini", "Cmc030.ini", "Cmc031.ini", "Cmc091.ini", "Cmc038.ini", "Cmc039.ini", "Cmc012.ini",
	...
	{	//MAGICIAN 
		...
		"mD030.ini",  "mD031.ini",  "mD032.ini",
		// Trajes (Armaduras)
		"mD001.ini",  "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini",
		"Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini",
		"Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini", "Cmd001.ini",
		// Trajes (T)
		"Cmd035.ini", "Cmd004.ini", "Cmd037.ini", "Cmd029.ini", "Cmd030.ini", "Cmd031.ini", "Cmd091.ini", "Cmd038.ini", "Cmd039.ini", "Cmd012.ini",
		"Cmd013.ini", "Cmd014.ini", "Cmd015.ini", "Cmd017.ini", "Cmd026.ini", "Cmd040.ini",
	},
	{ "E001.ini" , "E001.ini",  "E002.ini",  "E003.ini",  "E033.ini",  "E005.ini",  "E006.ini",  "E007.ini", "E008.ini", "E009.ini", "E010.ini",
	"E011.ini" , "E012.ini",  "E013.ini",  "E014.ini",  "E015.ini",  "E016.ini",  "E017.ini",  "E018.ini", "E019.ini", "E020.ini", "E021.ini",
	"E122.ini" , "E022.ini",  "E023.ini",  "E024.ini", "E025.ini",  "E026.ini",  "E028.ini",  "E028.ini",  "E029.ini",
	"E034.ini", "E032.ini", "E031.ini", "E031.ini", "E033.ini", "Ce002.ini", "Ce002.ini", "Ce002.ini",
	...
	"E001.ini",
	"E033.ini", "E034.ini", "E035.ini", "E036.ini", // ee304 eome? no primeiro eesse linhe
	"Ce032.ini", "Ce005.ini", "Ce035.ini", "Ce036.ini", "Ce026.ini", "Ce040.ini", "Ce029.ini", "Ce030.ini", "Ce031.ini", "Ce091.ini", "Ce038.ini", "Ce039.ini", "Ce009.ini", "Ce008.ini", "Ce016.ini", "Ce023.ini",
	"Ce092.ini","Ce093.ini","Ce094.ini","Ce095.ini","Ce096.ini","Ce097.ini","Ce098.ini","Ce099.ini","Ce004.ini","Ce007.ini","Ce008.ini",
	"Ce009.ini","Ce010.ini","Ce012.ini","Ce013.ini","Ce014.ini","Ce015.ini","Ce016.ini","Ce017.ini","Ce023.ini","Ce024.ini","Ce025.ini","Ce026.ini","Ce027.ini","Ce028.ini","Ce029.ini",
	},
};
