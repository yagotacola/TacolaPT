...
// 렌더링을 위한 연산과 정렬
int smSTAGE3D::RenderGeom() { return TRUE; }

#define STAGE_RECT_LIMIT		(30*64*fONE)
#define STAGE_RECT_LIMIT2		(240*64*fONE)

int smSTAGE3D::DrawStage(int x , int y, int z, int angX, int angY, int angZ , smEMATRIX *eRotMatrix ) { return TRUE; }



int smSTAGE3D::DrawStage2(int x , int y, int z, int angX, int angY, int angZ , smEMATRIX *eRotMatrix ) { return TRUE; }



//######################################################################################
//작 성 자 : 오 영 석
int smSTAGE3D::DrawOpeningStage(int x, int y, int z, int angX, int angY, int angZ, int FrameStep ) { return TRUE; }
//######################################################################################
