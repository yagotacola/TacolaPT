...
int ISAOCHECK::BreakUPClan(char* ClanZang_ID, char* gserver, char* ClanZang_ChaName, char* ClanName)
{
	...
	wsprintf(szWriteBuffer, "http://%s/ServerMain/clanRemove.asp?userid=%s&gserver=%s&chname=%s&clName=%s&ticket=%d", hostName, ClanZang_ID, gserver, ClanZang_ChaName, ClanName, nClanTicket);
