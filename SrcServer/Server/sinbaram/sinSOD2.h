...
public:
	void*  lpSiegeTax;             //재정메인
	void*  lpSiegeDefense;         //방어메인
	void*  lpCastleButton;         //성메인
	void*  lpMercenary;            //용병메인


	void*  lpDefenseButton[2];     //성/용병설정 버튼
	void*  lpTax_Ok[2];            //돈찾기 확인버튼
	
	void*  lpSiegeDefeseIcon_[3];     //성의 방어설정 아이콘 그레이
	void*  lpSiegeMercenaryIcon_[3];  //용병 아이콘 그레이


	void*  lpSiegeDefeseIcon[3];    //성의 방어설정 아이콘
	void*  lpSiegeClanskillIcon[3]; //클랜 스킬 아이콘
	void*  lpSiegeMercenaryIcon[3]; //용병아이콘

	void*  lpSiegeTaxButton;        //재정설정 메인버튼
	void*  lpSiegeDefenseButton;    //방어설정 메인버튼
	void*  lpSiegeOkButton;         //확인 버튼 
	void*  lpSiegeCancelButton;     //취소버튼

	void*  lpCastleIcon[6];         //성의 종류 활성화 버튼
	void*  lpTaxScroll[2];          //스크롤 버튼
	void*  lpTaxGraph;              //스크롤
	void*  lpDefenseRect[6];        //방어설정 활성화

	void*  lpTwoerImage;

	//
	void* haPlayerButton_G[3];
	void* haPlayerButton[3];
	void* haPlayerButtonBox[3];
	void* haPlayerButtonDown[3];
};
...
extern void*	lpbltr_Button_OK;
extern void*	lpbltr_Button_OK_G;
