...
#define SKILL_PLAY_STINGGER					0xA3
#define SKILL_PLAY_RUNNING_HIT				0xA4
#define SKILL_PLAY_DUALSWORDMASTERY			0xA5
#define SKILL_PLAY_WISP       	 			0xA6
#define SKILL_PLAY_VENOM_THRONE  			0xA7
#define SKILL_PLAY_ALAS      				0xA8
#define SKILL_PLAY_SOUL_SHOCK				0xA9
#define SKILL_PLAY_ATTACK_MASTERY			0xAA
#define SKILL_PLAY_SORE_SWORD       		0xAB
#define SKILL_PLAY_BEAT_UP       			0xAC
#define SKILL_PLAY_INPES     				0xAD
#define SKILL_PLAY_BLIND         			0xAE
#define SKILL_PLAY_FROST_WIND				0xAF
#define SKILL_PLAY_FATAL_MASTERY			0xB0
#define SKILL_PLAY_POLLUTED      			0xB1
#define SKILL_PLAY_PASTING_SHADOW      		0xB2
