...
/*----------------------------------------------------------------------------*
*	∆ƒ¿œ∏ÅE:  sinMsg.cpp
*	«œ¥¬¿œ :  ¥Ÿ∏•ææ˚‹« ƒ¡πˆ¡Ø¿ª ¿ß«ÿ ∏ﬁºº¡ˆ∏¶ ∞ÅE?—¥?
*	¿€º∫¿œ :  √÷¡ææ˜µ•¿Ã∆Æ 4øÅE
*	¿˚º∫¿⁄ :  π⁄ªÛø≠ 
*-----------------------------------------------------------------------------*/	
...
char *SmeltingResultTitle = "Result of smelting";		// pluto ¡¶∑√
char *ManufactureResultTitle = "Result of manufacturing";	// pluto ¡¶¿€
...
char *CristalItem     ="the 7 Crystals";//¿œ∞ˆ∞°¡ˆ ≈©∏ÆΩ∫≈ª ∫∏¿∫
...
char* sinTestMsg7("Hurray, Neh Neh Neh Boo Boo, You're losers!");
...
char *PremiumItemDoc[][2]={
	{"It makes stat points\r"     ,"to be restributed.\r"},     //Ω∫≈» √ ±‚»≠ æ∆¿Ã≈€
	{"It makes skill points\r"     ," to be restributed.\r"},    //Ω∫≈≥ √ ±‚»≠ æ∆¿Ã≈€
	{"It makes stat/skill points\r"," to be restributed.\r"},     //Ω∫≈»/Ω∫≈≥ √ ±‚»≠ æ∆¿Ã≈€
	{"It makes the dead character \r"    ,"to be revived.\r"},        //∫Œ»∞ æ∆¿Ã≈€
	{"Becomes invincible for the set time.\r","The attack power decrease in 1/2\r"},    //¿Ã≈Õ≥Œ ∂Û¿Ã«¡
	{"15% increase \r"    ,"on the critical attack.\r"},		//∆‰¿Ã∆≤ ø°¡ˆ
	{"15% increase of \r"         ,"evade chance.\r"},		//ø°πˆ∆Æ Ω∫≈©∑—
};
char *UpKeepItemDoc[] = {
#ifdef USE_NEW_FEATURES
