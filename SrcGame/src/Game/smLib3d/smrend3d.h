...
#define RENDER_FACE_MAX 100000
#define RENDER_VERTEX_MAX 100000

#define TEMPTEXLINK_MAX 50000
...
struct RenderLight
{
	Delta3D::Math::Vector3 position;
	float range;
	Delta3D::Math::Color color;
};
...
public:
	...
	bool LoadUsingNewRender = false;
	bool IgnoreRender = false;
	bool RenderingMap = false;
	std::vector<RenderLight> Lights;
	std::shared_ptr<Delta3D::Graphics::Shader> TerrainShader;
