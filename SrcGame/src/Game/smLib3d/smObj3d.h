...
public:
	...
	void TmAnimationGate(int frame, Delta3D::Math::Vector3Int* angle, SMotionStEndInfo* lpFrameInfo = NULL, smFMATRIX* out = nullptr);
	...
	int  TmAnimation(int frame, int ax, int ay, int az, SMotionStEndInfo* lpFrameInfo = NULL, smFMATRIX* out = NULL);
	...
	int  LoadFile(FILE* hFile, smPAT3D* PatPhysique = 0);
};
...
public:
	...
	int nObj3d;
	LPDIRECT3DTEXTURE9* hD3DTexture;
	...
	Delta3D::Graphics::Model* newModel;
