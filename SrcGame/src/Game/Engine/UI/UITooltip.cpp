...
namespace UI
{
	...
	void Tooltip::Init()
	{
		pBorderImages[0] = ImageLoader::LoadImage_("game\\images\\UI\\tooltip\\bottomleft.png");
		pBorderImages[1] = ImageLoader::LoadImage_("game\\images\\UI\\tooltip\\bottomright.png");
		pBorderImages[2] = ImageLoader::LoadImage_("game\\images\\UI\\tooltip\\left.png");
		pBorderImages[3] = ImageLoader::LoadImage_("game\\images\\UI\\tooltip\\top.png");
		pBorderImages[4] = ImageLoader::LoadImage_("game\\images\\UI\\tooltip\\topleft.png");
		pBorderImages[5] = ImageLoader::LoadImage_("game\\images\\UI\\tooltip\\topright.png");
	}

	void Tooltip::SetLinkObjectxD(Element_ptr pObject)
	{
		//Link Object
		pLinkObject = pObject;
	}
	...
	BOOL Tooltip::OnMouseMove(CMouse* pcMouse, int iX, int iY, int iWidth, int iHeight, int iSourceX, int iSourceY)
	{
