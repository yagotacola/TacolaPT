...
namespace UI
{
	...
	public:
		...
		void SetHeadModel(char* pszHeadModel);
		void SetBodyModel(char* pszBodyModel);

		static void LoadUnitData(UnitData* pcUnitData, char* pszBodyModel, char* pszHeadModel);
