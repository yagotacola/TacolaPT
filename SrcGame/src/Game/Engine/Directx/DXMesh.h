...
#include "Utils/X3DQuaternion.h"
#include "Utils/X3DAABB.h"
#include "Utils/X3DSphere.h"
#include "Utils/X3DMatrix4.h"
...
namespace DX
{
	...
	public:
		...
		// void SetSkinIndices( const std::vector<std::array<float, 1>> & v ) { vSkinIndices = v; }
		// const std::vector<std::array<float, 1>> & GetSkinIndices() const { return vSkinIndices; }
	...
	protected:
		...
		// std::vector<std::array<float, 1>> vSkinIndices;
