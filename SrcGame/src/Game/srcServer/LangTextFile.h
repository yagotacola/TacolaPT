...
char* HoTextLoginMessage[21] = { "Entrando no Servidor...",
"Não foi possível se conectar ao servidor",
"ID errado, digite novamente!",
"Senha errada, digite novamente!",
"ID Bloqueada, faça um pedido de Suporte!",
"Essa ID já está Online!",
...
"Não permitido",
"Não permitido",
"Conta não ativada, acesse o painel e confirme seu email!"
};
...
/* Maybe " A tribo dos Tempskrons ,famosa por suas ténicas de combate e sua grande habilidade com váios tipos de armas"*/
" Conhecida pela sua tecnologia avançada, a tribo dos Tempskrons é a uníca capaz de usar máquinas modernas a favor do combate.",
...
char* HoTextFriendRefuse = "Ignorados %d/%d";