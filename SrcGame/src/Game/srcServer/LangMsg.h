...
sMESSAGEBOX	sMessageBox[100] = {
	...
	{ "Excede o número Máximo de Itens" },
	{ "Troca cancelada" },
	...
	{ " +1 Ponto de Habilidade e +5 Pontos de Status" },
	{ " +2 Pontos de Habilidade e +5 Pontos de Status" },
	...
	{ "Você já respondeu estas perguntas" },
...
sMESSAGEBOX2 sMessageBox2[20] = {
	...
	{ "Quantos itens", "deseja abandonar?" },
	{ "Quanto dinheiro", "deseja abandonar?" },
	{ "", "" },
	{ "Quanto dinheiro", "deseja trocar?" },
	{ "Quanto dinheiro", "deseja transferir?" },
	{ "Quanto dinheiro", "deseja retirar?" },
	{ "Quantas estrelas", "deseja comprar?" },
	{ "Quanto dinheiro", "deseja doar?" },
	{ "Você deseja registrar", "o preço de item? " },
	{ "Quantos itens", "deseja comprar?" },  //°³ÀÎ»óÁ¡ Æ÷¼Ç
	{ "Quanto dinheiro", "deseja retirar?" },
	{ "Você deseja", "comprar o item?" },
	{ "Você deseja", "comprar o item?" }, //14¹øÂ° ¿ä³Ñ¸¸ ÁøÂ¥
	{ "Quanto dinheiro", "deseja investir?" },//°ø¼ºÀü µ·Ã£±â
	{ "Quantos mercenários ", "deseja contratar?" },
	{ "Quantos Coins ", "deseja trocar?" }
};
...
char* LinkGroupName = "Transportar-se ao membro do Grupo\r";
...
char* VelocityAdd = "Velocidade Add:\r";
char* sinSkillType = "Efeito da Habilidade:\r";
char* sinSkillType2[2] = { "Off\r","On\r" };
...
//char *ChainNum4 = "No. de inimigos:\r";
char* ChainRange4 = "Alcance Mágico : \r";
...
char* SheltomName2[] = { "Lucidy", "Sereno", "Fadeo", "Sparky", "Raident", "Transparo", "Murky", "Devine", "Celesto", "Mirage", "Inferna", "Enigma","Bellum", "Ordo", "Safira" };
...
char* UpKeepItemDoc[] = {
	"Tempo restante : %d:%02d:%02d",
	"Tx. de Drop %d%s adicional",
	"Exp. %d%s adicional",
	"Ataque %d%s adicional",
	"Converte 5%% do dano em HP",
	"Converte 5%% do dano em MP",
