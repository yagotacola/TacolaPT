...
struct sHACLANDATA{
	...
	LPDIRECT3DTEXTURE9 lpClanMark;  //클랜 마크	   
};
...
public:
	LPDIRECT3DTEXTURE9  lpSiegeTax;             //재정메인
	LPDIRECT3DTEXTURE9  lpSiegeDefense;         //방어메인
	LPDIRECT3DTEXTURE9  lpCastleButton;         //성메인
	LPDIRECT3DTEXTURE9  lpMercenary;            //용병메인


	LPDIRECT3DTEXTURE9  lpDefenseButton[2];     //성/용병설정 버튼
	LPDIRECT3DTEXTURE9  lpTax_Ok[2];            //돈찾기 확인버튼
	
	LPDIRECT3DTEXTURE9  lpSiegeDefeseIcon_[3];     //성의 방어설정 아이콘 그레이
	LPDIRECT3DTEXTURE9  lpSiegeMercenaryIcon_[3];  //용병 아이콘 그레이


	LPDIRECT3DTEXTURE9  lpSiegeDefeseIcon[3];    //성의 방어설정 아이콘
	LPDIRECT3DTEXTURE9  lpSiegeClanskillIcon[3]; //클랜 스킬 아이콘
	LPDIRECT3DTEXTURE9  lpSiegeMercenaryIcon[3]; //용병아이콘

	LPDIRECT3DTEXTURE9  lpSiegeTaxButton;        //재정설정 메인버튼
	LPDIRECT3DTEXTURE9  lpSiegeDefenseButton;    //방어설정 메인버튼
	LPDIRECT3DTEXTURE9  lpSiegeOkButton;         //확인 버튼 
	LPDIRECT3DTEXTURE9  lpSiegeCancelButton;     //취소버튼

	LPDIRECT3DTEXTURE9  lpCastleIcon[6];         //성의 종류 활성화 버튼
	LPDIRECT3DTEXTURE9  lpTaxScroll[2];          //스크롤 버튼
	LPDIRECT3DTEXTURE9  lpTaxGraph;              //스크롤
	LPDIRECT3DTEXTURE9  lpDefenseRect[6];        //방어설정 활성화
