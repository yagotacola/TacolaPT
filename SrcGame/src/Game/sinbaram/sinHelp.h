...
#define SIN_HELP_KIND_TELEPORT_MAR	24
#define SIN_HELP_KING_TELEPORT_ARENA	25
#define SIN_HELP_KIND_TELEPORT_BA 26
#define SIN_HELP_KIND_TRADEBPEXP 27
#define SIN_HELP_DAILYQUEST		28
...
public:
	...
	LPDIRECT3DTEXTURE9	lpSodJobFace[8];

	DWORD dwWindowImage;
	DWORD dwQuestWindowImage;
	DWORD dwButtonOK[2];
	DWORD dwButtonClose[2];
	DWORD dwCheckBox[2];
...
public:
	...
	void CheckBox( HDC h, int x, int y, char * text, bool b );
