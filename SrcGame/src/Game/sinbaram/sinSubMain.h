...
#define MAX_SIN_KIND_INTER		17  //보여질 각종 폼 // 석지용 - 믹스쳐 리셋 창 추가
...
#define SIN_CARAVANA 13
#define SIN_SOCKET		14
#define SIN_ELEMENT		15
#define SIN_SYSTEM		18
...
int SendWingEventPRISTONItem(); // event priston xxstr
