...
#define MESSAGE_MOVE_COIN_TRADE		    17
...
#define MESSAGE_TELEPORT_MAR		63
#define MESSAGE_TELEPORT_ARENA		64
#define MESSAGE_TELEPORT_BA	65
#define MESSAGE_TRADE_BPEXP 66
#define MESSAGE_DAILYQUEST 67
#define MESSAGE_NEWTELEPORT 68
#define MESSAGE_CONFIRMATION_BOX		69
#define MESSAGE_COIN_SHOP        		70
#define MESSAGE_BP_SHOP        		72
#define MESSAGE_ARENA 73
#define MESSAGE_DONATE 74
#define MODOPVP             75
#define MESSAGE3_MAX					76
...
public:
	...
	LPDIRECT3DTEXTURE9	lpArrowUpDown[2]; // 0 Up  1 Down

	LPDIRECT3DTEXTURE9	lpButtonNo[2];     // 0 Yes 1 No
	LPDIRECT3DTEXTURE9	lpButtonYes[2];    // 0 Yes 1 No

	LPDIRECT3DTEXTURE9	lpButtonOk[2];     // 0 Ok 1 Cancel
	LPDIRECT3DTEXTURE9	lpButtonCancel[2]; // 0 Ok 1 Cancel
	LPDIRECT3DTEXTURE9    lpCount;		   //아이템 갯수 창 	
