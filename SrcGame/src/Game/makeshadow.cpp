...
BOOL CollisionLineVSPolygon( LPD3DXVECTOR3 lpCollisionPoint, LPD3DXVECTOR3
lpLineBegin, LPD3DXVECTOR3 lpLineEnd, LPD3DXVECTOR3 lpPolygonVtx1, LPD3DXVECTOR3
lpPolygonVtx2, LPD3DXVECTOR3 lpPolygonVtx3 );

int smVectMatrix(LPD3DXVECTOR3 lpPolygonVtx1, 
				 LPD3DXVECTOR3 lpPolygonVtx2, 
				 LPD3DXVECTOR3 lpPolygonVtx3 );
...
{
	int cnt;
	D3DXVECTOR3 CollisionPoint, Line[2];
	D3DXVECTOR3 v[3];
