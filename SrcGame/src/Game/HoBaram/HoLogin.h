...
private:
	...
	//상태에 대한 표시 이미지.
	//LPDIRECT3DTEXTURE9	CharacterSelectImage;
	...
	//MapImage
	LPDIRECT3DTEXTURE9	GameMapImage;
	int						MapBlendCount;
	BOOL					MapBlendFlag;
