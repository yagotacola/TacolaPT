...
#define CLASS_PVP_EFFECT				1413
#define CLASS_LEVEL_EFFECT				1414
...
// effect kingpvp xxstr
class AssaSkillKingPVP : public cASSAEFFECT
{
public:
	AssaSkillKingPVP();
	~AssaSkillKingPVP();
...
class AssaSkillTopLVL : public cASSAEFFECT
{
public:
	AssaSkillTopLVL();
	~AssaSkillTopLVL();
...
public:
	...
	//void Start(smCHAR* curChar, smCHAR* destChar, D3DXVECTOR3* velocity, int liveCount);
	void Start(POINT3D *pShotPos, POINT3D *pAttackPos, D3DXVECTOR3* velocity);//, int liveCount);
	void Draw(POINT3D *pPosi , POINT3D *pAngle);
	void Main();
...
class AssaPVPEffect :public cASSAEFFECT
{
public:
	AssaPVPEffect();
	~AssaPVPEffect();
