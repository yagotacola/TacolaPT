...
public:
	...
	~HoParticle();
public:
	D3DXVECTOR3		PrevLocation;	//마지막으로 업데이트된 파티클의 위치.
	D3DXVECTOR3		Location;		//현재의 파티클의 위치.
	
	D3DXVECTOR3		Velocity;		//파티클의 속도 벡터.
...
public:
	...
	D3DXVECTOR3	 PrevLocation;		//파티클의 이전 위치
	D3DXVECTOR3	 Location;			//파티클의 현재 위치

	D3DXVECTOR3	 Velocity;			//파티클의 속도
	D3DXVECTOR3    Direction;			//파티클의 방향..
