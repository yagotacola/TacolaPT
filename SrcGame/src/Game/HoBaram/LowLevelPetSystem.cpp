		...
		switch(eEvent)
		{
			...
			case FsmStateEvent::EVENT_UPDATE:
			{
				...
				if ( m_TargetChar->chrAttackTarget && m_TargetChar->chrAttackTarget->Flag && 
					m_TargetChar->chrAttackTarget->smCharInfo.Brood!=smCHAR_MONSTER_USER && // π⁄¿Áø¯ - ««¥–Ω∫ ∆Í¿Ã ¿Ø¿˙ ≈©∏ÆΩ∫≈ª ∏ÛΩ∫≈Õ¥¬ ∞¯∞›æ»«—¥Ÿ.(∞∞¿∫∆Ì¿Ãπ«∑Œ)
...
bool HoLowLevelPetManager::Create()
{
	...
	m_Bone = smASE_ReadBone( "Effect\\LowLevelPet\\Pet_motion.ASE");		// æ÷¥œ∏ﬁ¿Ãº« ¿–±‚
