...
extern int DrawThreeLineMessage(int x, int y, char *messageOne, char *messageTwo, char *messageThree, DWORD color1, DWORD color2, DWORD color3, LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);
