...
public:
	...
	LPDIRECT3DTEXTURE9 hMicSortLine;	// 마이크옵션 가로줄
	LPDIRECT3DTEXTURE9 hMicONBack;	// 마이크on,off백그라운드
	LPDIRECT3DTEXTURE9 hMicONChk;	// 마이크 on체크이미
	LPDIRECT3DTEXTURE9 hMicVolBar;	// 마이크옵션 볼륨바
