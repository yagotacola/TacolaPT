...
typedef struct {
	...
	DWORD CNFlag; //sod¡÷∞¸ ≈¨∑£¿« ∏‚πˆ¿Œ¡ˆ¿« ø©∫Œ	//cE_isclanmember.cppø°º≠ º¬∆√µ 
} CLANDATA;
...
public:
	...
	/*
	LPDIRECT3DTEXTURE9				hBox1_ktj; //»Æ¿Œ

	LPDIRECT3DTEXTURE9				hOk_Gray,hOk_Yellow; //»Æ¿Œ
	LPDIRECT3DTEXTURE9				hCancel_Gray,hCancel_Yellow; //√Îº“
	LPDIRECT3DTEXTURE9				hYes_Gray,hYes_Yellow; // øπ
	LPDIRECT3DTEXTURE9				hNo_Gray,hNo_Yellow; //æ∆¥œø¿
	...
	LPDIRECT3DTEXTURE9	hWareHouse[2]; //∏∂øÏΩ∫∞° ¿ß∑Œ ø√∂Ûø‘¿ª∂ß
	...
	LPDIRECT3DTEXTURE9   hTxt_Remove[2]; //√ﬂπÊ
	LPDIRECT3DTEXTURE9   hTxt_Release[2]; //«ÿ√º
	LPDIRECT3DTEXTURE9   hTxt_Mark[2]; //∏∂≈©
	LPDIRECT3DTEXTURE9   hTxt_Help[2]; //µµøÚ∏ª
	LPDIRECT3DTEXTURE9   hTxt_Secession[2];//≈ª≈
	*/
...
#ifndef _LANGUAGE_BRAZIL //∫Í∂Û¡˙ ≈¨∑£ //«ÿø‹
...
extern CLANDATA chacldata[6];	//∞Ë¡§ø° ∏∏µÈæÓ¡¯ ƒ≥∏Ø≈ÕµÈ¿Ã ∞°¿‘«— ≈¨∑£¡§∫∏ ¿˙¿Â
