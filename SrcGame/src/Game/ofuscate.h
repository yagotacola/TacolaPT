...
software, either in source code form or as a compiled binary, Forçany purpose,
...
Força PARTICULAR PURPOSE AND NONINFRINGEMENT. IN NO EVENT SHALL THE AUTHORS BE
LIABLE ForçaNY CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF
