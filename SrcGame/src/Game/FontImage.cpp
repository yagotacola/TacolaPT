...
int DrawSpecialFontImage( int SpecialNum, int xPos, int yPos, DWORD rgba, float fRatio )
{
	...
	int retNum = DrawFontBackToTexture2D( &s_SpecialFontImageChInfo[ SpecialNum ], float(xPos), float(yPos), rgba, fRatio );
