...
// pluto 신규필드 몬스터
#define snCHAR_SOUND_REVIVED_KNIGHT		0x18F0	// 나이트
#define snCHAR_SOUND_REVIVED_MAGICIAN	0x1900 // 매지션
#define snCHAR_SOUND_REVIVED_ARCHER		0x1910 // 아쳐
#define snCHAR_SOUND_REVIVED_ATALANTA	0x1920 // 아탈란타
#define snCHAR_SOUND_REVIVED_FIGTHER	0x1930 // 파이터
#define snCHAR_SOUND_REVIVED_MECANICIAN	0x1940 // 메카니션
#define snCHAR_SOUND_REVIVED_PIKEMAN	0x1950 // 파이크맨
#define snCHAR_SOUND_REVIVED_PRIESTESS	0x1960 // 프리스티스
#define snCHAR_SOUND_DEADHOPT			0x1970 // 데드호피
#define snCHAR_SOUND_DEADKINGHOPY		0x1980 // 언데드 킹호피
#define snCHAR_SOUND_GORGON				0x1990 // 고르곤
#define snCHAR_SOUND_HOBOGOLEM			0x19A0 // 호보고렘

// 박재원 - 저주받은 신전 3층(신규필드 몬스터)
#define snCHAR_SOUND_NIKEN				0x19B0 // 니켄
#define snCHAR_SOUND_MIMIC				0x19C0 // 미믹
#define snCHAR_SOUND_KINGBAT			0x19D0 // 킹뱃
#define snCHAR_SOUND_GOBLINSHAMAN		0x19E0 // 고블린샤먼
#define snCHAR_SOUND_HEST				0x19F0 // 헤스트

// 박재원 - 끝없는 탑 3층(신규필드 몬스터)
#define snCHAR_SOUND_RUCA				0x2100 // 루카
#define snCHAR_SOUND_NAZSENIOR			0x2110 // 나즈 시니어
#define snCHAR_SOUND_IGOLATION			0x2120 // 이골라티온
#define snCHAR_SOUND_KAKOA				0x2130 // 카코아
#define snCHAR_SOUND_SPRIN				0x2140 // 스프린
#define snCHAR_SOUND_UNDEADMAPLE		0x2150 // 언데드 메이플
#define snCHAR_SOUND_XETAN				0x2160 // 제탄

// 박재원 - 복날 이벤트 몬스터 추가
#define snCHAR_SOUND_BEBECHICK			0x2170 // 아기 꼬꼬
#define snCHAR_SOUND_PAPACHICK			0x2180 // 아빠 꼬꼬
...
int	InitSoundEffect( HWND hWnd );			////사운드 초기화
int CloseSoundEffect();						////사운드 닫기
int	CharPlaySound( smCHAR *lpChar );		//캐릭터 사운드 연주
int	WeaponPlaySound( smCHAR *lpChar );		//무기 사운드 연주
...
#define	SKILL_SOUND_SKILL_EVASION_MASTERY					0x4320
