...
{
	if (!Settings::GetInstance()->cSound)
		return TRUE;

	if (Settings::GetInstance()->cSVol == 0)
		dwVol = 0;
	if (Settings::GetInstance()->cSVol == 1)
		dwVol = (30 * dwVol) / 100;
	if (Settings::GetInstance()->cSVol == 2)
		dwVol = (40 * dwVol) / 100;
	if (Settings::GetInstance()->cSVol == 3)
		dwVol = (50 * dwVol) / 100;
	if (Settings::GetInstance()->cSVol == 4)
		dwVol = (60 * dwVol) / 100;
	if (Settings::GetInstance()->cSVol == 5)
		dwVol = (70 * dwVol) / 100;
	if (Settings::GetInstance()->cSVol == 6)
		dwVol = (80 * dwVol) / 100;
	if (Settings::GetInstance()->cSVol == 7)
		dwVol = (90 * dwVol) / 100;
	if (Settings::GetInstance()->cSVol == 8)
		dwVol = dwVol;
...
HRESULT SetupStreamBuffer(LPSTR lpszFilename)
{
	...
	int dwVol = VOL_MAX;
	if (Settings::GetInstance()->cMusic)
	{
		if (Settings::GetInstance()->cMVol == 0)
			dwVol = 0;
		if (Settings::GetInstance()->cMVol == 1)
			dwVol = (30 * dwVol) / 100;
		if (Settings::GetInstance()->cMVol == 2)
			dwVol = (40 * dwVol) / 100;
		if (Settings::GetInstance()->cMVol == 3)
			dwVol = (50 * dwVol) / 100;
		if (Settings::GetInstance()->cMVol == 4)
			dwVol = (60 * dwVol) / 100;
		if (Settings::GetInstance()->cMVol == 5)
			dwVol = (70 * dwVol) / 100;
		if (Settings::GetInstance()->cMVol == 6)
			dwVol = (80 * dwVol) / 100;
		if (Settings::GetInstance()->cMVol == 7)
			dwVol = (90 * dwVol) / 100;
		if (Settings::GetInstance()->cMVol == 8)
			dwVol = dwVol;
	}
	else
		dwVol = 0;
