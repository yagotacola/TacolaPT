...
class CPartyWindow: public CBaseWindow
{
	enum EWindow1
	{
		WINDOWID_Member1,
...
public:
	static              CPartyWindow* GetInstance() { static CPartyWindow instance; return &instance; }

	//Constructor
	CPartyWindow(EWindow eID);
	CPartyWindow();
	~CPartyWindow();
