...
public:
	...
	void DrawTwoLineMessage(int x, int y, char* message1, char* message2, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);

	void DrawTwoLineMessageTitle(int x, int y, char* message1, char* message2, char* message3, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), DWORD color3 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);
	void DrawTwoLineMessageTop(int x, int y, char* message1, char* message2, char* message3, DWORD color1 = RGB(0, 0, 0), DWORD color2 = RGB(0, 0, 0), DWORD color3 = RGB(0, 0, 0), LPDIRECT3DTEXTURE9 clanMark = NULL, BOOL selected = FALSE, int bellaMarkIndex = -1);
	void DrawThreeLineMessage(int x, int y, char* message1, char* message2, char* message3, DWORD color1, DWORD color2, DWORD color3, LPDIRECT3DTEXTURE9 clanMark, BOOL selected, int bellaMarkIndex);

	void DrawCharacterMessage(int x, int y, char* message, int lineSize = 30, LPDIRECT3DTEXTURE9 clanMark = NULL, char* clanName = NULL, DWORD color1 = RGB(0, 0, 0), BOOL selected = FALSE, int bellaMarkIndex = -1);
	...
	void DrawClanMark(LPDIRECT3DTEXTURE9 clanMark, char* clanName, int x, int y, BOOL frameFlag = FALSE);
	void DrawClanMark1(LPDIRECT3DTEXTURE9 clanMark, char* clanName, int x, int y, BOOL frameFlag);
	...
	void DrawShopSellMessage(int x, int y, char* message, int lineSize = 30, LPDIRECT3DTEXTURE9 clanMark = NULL, DWORD color1 = RGB(0, 0, 0), BOOL selected = FALSE);
	void DrawShopSellMessageFrame(int x, int y, int messageWidth, int messageHeight, bool tailFlag = false, BOOL selected = FALSE);


	void DrawShopByeMessage(int x, int y, char* message, int lineSize = 30, LPDIRECT3DTEXTURE9 clanMark = NULL, DWORD color1 = RGB(0, 0, 0), BOOL selected = FALSE);
