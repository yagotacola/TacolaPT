...
static void DrawEventScore(void)
{
	...
	for( int i=0; i < g_EventScore.TeamNum; i++ )
	{
		...
		DrawSpecialFontImage( g_EventScore.TeamMarkBuff[i],
							  ...
							  D3DCOLOR_RGBA(255,255,255,255) ); //, g_fWinSizeRatio_X );
...
void CreateBellatraFontEffect(void)
{
	...
	s_EventScore_Font = ::CreateFont( 16,0,0,0,FW_NORMAL,FALSE,FALSE,FALSE, ANSI_CHARSET | FS_LATIN1,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,VARIABLE_PITCH,"Comic Sans MS" );
#endif
